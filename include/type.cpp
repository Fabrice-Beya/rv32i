...
/*
 * Use the RV32I ISA definitions to map the 5 bit opcode to the associated instruction type
 * This can be reduced to a mapping of 2 bit -> 3 bit which indicate the type
 */
